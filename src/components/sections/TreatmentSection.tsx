...
import { companyData, treatmentComparison, procedureData } from "@/constants/siteData";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-8 relative">
            ...
            <div className="overflow-x-auto rounded-2xl shadow-xl border border-[#a6c516]/30">
              <table className="w-full text-left bg-white min-w-[800px] table-fixed border-collapse">
                ...
                <thead>
                  <tr className="bg-[#3b7dba] text-white">
                    ...
                    <th className="p-4 md:p-6 text-base font-bold align-middle text-center bg-[#7ba832] relative rounded-tr-2xl">
                ...
                <tbody className="divide-y divide-gray-100">
                  ...
                  <tr className="bg-white">
                    <td className="py-5 px-4 md:px-6 font-bold text-gray-800 text-sm md:text-base align-middle border-r border-black/[0.08]">
                      Lens Design
                    </td>
                    {/* Fixed 120×100 icon container — images center reliably regardless of intrinsic dimensions */}
                    <td className="py-5 px-4 md:px-6 align-middle border-r border-black/[0.08]">
                    ...
                    <td className="py-5 px-4 md:px-6 align-middle bg-[#f2f8dc]">
                      {/* Same fixed container — neutralises any right-bias from trifocal image padding */}
                      <div className="w-[120px] h-[100px] flex items-center justify-center mx-auto">
                        <Image
                          src="/assets/trifocal1.png"
                          alt="Trifocal Lens"
                          width={110}
                          height={90}
                          className="rounded-xl object-contain max-w-full max-h-full"
                  ...
                  {treatmentComparison.rows.map((row, idx) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4 md:px-6 font-bold text-gray-800 text-sm md:text-base align-middle leading-[1.5] border-r border-black/[0.08]">
                        {row.feature}
                      </td>
                      ...
                      {[row.mono, row.toric, row.enhancedMono, row.trifocal].map((val, colIdx) => (
                        <td
                          key={colIdx}
                          className={`py-4 px-4 md:px-6 align-middle leading-[1.5] ${colIdx === 3
                            ? "bg-[#f2f8dc]"
                        ...
                        >
                          ...
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <span
                              className={`text-sm text-center md:text-[0.9rem] leading-[1.5] ${row.positive.includes(colIdx)
                                ? colIdx === 3
